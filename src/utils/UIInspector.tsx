...
export const UIInspector = ({ enabled = false }: { enabled?: boolean }) => {
  if (enabled) {
    return (
      <div
        className="fixed bottom-0 left-0 flex h-8 w-8 items-center justify-center border bg-neutral-50 p-6 font-bold opacity-75"
        style={{ zIndex: 1000 }}
      >
